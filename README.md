...
* [promiseAny.js](https://obscurejavascript.tumblr.com/post/189814490444/waiting-for-the-first-returned-api-result-with): How to get the fastest returned API result with `Promise.any` and a simple example Polyfill for it.
